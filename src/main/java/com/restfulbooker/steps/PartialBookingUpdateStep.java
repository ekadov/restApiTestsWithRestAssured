...
public class PartialBookingUpdateStep {

    public Response sendBookingPartialUpdateRequest(BookingRequestPojo generatedBooking) {
        ...
        return specification.getSpecification()
                ...
                .when()
                .patch(Endpoints.BOOKING_ID, specificBooking);
    }
